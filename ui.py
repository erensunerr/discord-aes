...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.StartConversation = QtWidgets.QPushButton(self.centralwidget)
        self.StartConversation.setObjectName("StartConversation")
        self.gridLayout_3.addWidget(self.StartConversation, 0, 3, 1, 1)
        self.GetOlderMessages = QtWidgets.QPushButton(self.centralwidget)
        self.GetOlderMessages.setObjectName("GetOlderMessages")
        self.gridLayout_3.addWidget(self.GetOlderMessages, 0, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_8.setText(_translate("MainWindow", "Set Password"))
        self.pushButton.setText(_translate("MainWindow", "Get Live Key"))
        self.pushButton_2.setText(_translate("MainWindow", "Discard Key"))
        self.StartConversation.setText(_translate("MainWindow", "Start Conversation"))
        self.GetOlderMessages.setText(_translate("MainWindow", "Get Older Messages"))
